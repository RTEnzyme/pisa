...
void test_pm_freq_index()
{
    ...
    using collection_type = pisa::pm_freq_index<DocsSequence, FreqsSequence>;
...
TEST_CASE("pm_freq_index")
{
    ...
    test_pm_freq_index<indexed_sequence, positive_sequence<>>();

    test_pm_freq_index<partitioned_sequence<>, positive_sequence<partitioned_sequence<strict_sequence>>>();
    test_pm_freq_index<
